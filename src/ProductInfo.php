...
class ProductInfo
{
     ...
     * @return bool
     */
    private static function isInit(): bool
    {
        return self::$init;
    }
     ...
     * @param bool $init
     */
    private static function setInit(bool $init): void
    {
        self::$init = $init;
    }
     ...
     * @return array
     */
    public static function getDhlProducts(): array
    {
        if (! self::isInit()) {
            self::init();
        }
     ...
     */
    private static function addProduct(Product $product): void
    {
     ...
     */
    public static function getInfo(string $productType): ?Product
    {
        if (!self::isInit()) {
            self::init();
        }
